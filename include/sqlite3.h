...
static void sqlite3_freemem(void *p){ return; }


static int sqlite3_exec_vprintf(
  sqlite3 *db,                   /* An open database */
  const char *sqlFormat,        /* printf-style format string for the SQL */
  sqlite3_callback xCallback,    /* Callback function */
...
static int sqlite3_exec_printf(
  sqlite3 *db,                   /* An open database */
  const char *sqlFormat,        /* printf-style format string for the SQL */
  sqlite3_callback xCallback,    /* Callback function */
  void *pArg,                   /* 1st argument to callback function */
...
static int sqlite3_get_table_vprintf(
  sqlite3 * db, 
...
static int sqlite3_get_table_printf(
  sqlite3 *db,
